//Base generator for bio-system generators.
...
/datum/map_generator/biosystem/bioforest_generator/generate_terrain(list/turfs, area/generate_in)
	...
	for(var/t in turfs) //Go through all the turfs and generate them
		var/turf/gen_turf = t
		var/drift_x = (gen_turf.x + rand(-BIOFOREST_RANDOM_SQUARE_DRIFT, BIOFOREST_RANDOM_SQUARE_DRIFT)) / perlin_zoom
		var/drift_y = (gen_turf.y + rand(-BIOFOREST_RANDOM_SQUARE_DRIFT, BIOFOREST_RANDOM_SQUARE_DRIFT)) / perlin_zoom
